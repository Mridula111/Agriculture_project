...
export default function Analysis() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 flex">
      ...
      {/* Main Content Area: Offset by sidebar width and stacked vertically with footer */}
      <div className="flex-1 flex flex-col min-w-0 ml-0 md:ml-64">
        
        {/* Main Content */}
        <main className="flex-1 p-6 lg:p-10 w-full max-w-[1500px] mx-auto">
          ...
          <div className="space-y-6">
            ...
            <motion.section
              ...
              className="bg-stone-900 rounded-2xl border border-stone-800 shadow-md overflow-hidden"
            >
              <button
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-amber-600 rounded-xl flex items-center justify-center text-white shadow-md shadow-amber-600/20">
                    <Calculator size={20} />
                  </div>
                  <div>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="bg-stone-900 rounded-2xl border border-stone-800 p-6 shadow-md">
                <BarChart
                  data={MONTHLY_WATER}
            ...
            {/* ═══ GROWTH STAGES TABLE ═══ */}
            <section className="bg-stone-900 rounded-2xl border border-stone-800 p-6 shadow-md">
        ...
        {/* Footer sits naturally below the main content */}
        <Footer />
      </div>
    </div>
  );
