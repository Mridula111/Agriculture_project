...
export default function Analysis() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 text-stone-100 pl-0 md:pl-64 w-full flex flex-col justify-between">
      {/* Sidebar is fixed on left */}
      <Navbar />

      {/* Main Content: Full width with padding */}
      <main className="flex-1 w-full px-6 py-8 lg:px-12">
        {/* Header */}
        ...
        <div className="space-y-6 w-full">
          {/* ═══ YIELD PREDICTION ═══ */}
          <section className="bg-stone-900 rounded-2xl border border-stone-800 shadow-md overflow-hidden w-full">
            <button
